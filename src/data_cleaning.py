...
def load_raw_data() -> pd.DataFrame:
    raw_data_path = Path("data") / "raw" / "search_sample_data.parquet"
...
if __name__ == "__main__":
    ...
    # Save cleaned data
    cleaned_data_path = Path("data") / "processed" / "search_sample_data.parquet"
    data_df.to_parquet(cleaned_data_path)
    log.info("Data saved to /%s", cleaned_data_path)